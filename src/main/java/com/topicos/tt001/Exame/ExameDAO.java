...
// CRUD    
    public Exame create(String descricao, int idConsulta ) {
        try {
            ...
            stmt = DAO.getConnection().prepareStatement("INSERT INTO exames (descricao, idConsulta) VALUES (?,?)");
    ...
    public void update(Exame exame) {
        try {
            PreparedStatement stmt;
            stmt = DAO.getConnection().prepareStatement("UPDATE exames SET descricao=?, idConsulta=? WHERE id=?");
        ...
        // Delete   
    public void delete(Exame cliente) {
        PreparedStatement stmt;
        try {
